...
class IncomeTax {
    ...
    private static List generateIncomeTaxSlab() {
        return new ArrayList<IncomeTaxSlab>() {{
            add(new IncomeTaxSlab(income -> income > 0 && income <= 18200, income -> 0.0));
            add(new IncomeTaxSlab(income -> income > 18200 && income <= 37000, income -> (income - 18200) * .19));
            add(new IncomeTaxSlab(income -> income > 37001 && income <= 80000, income -> 3572 + (income - 37000) * .325));
            add(new IncomeTaxSlab(income -> income > 80001 && income <= 180000, income -> 17547 + (income - 80000) * .37));
            add(new IncomeTaxSlab(income -> income > 180001, income -> 54547 + (income - 180000) * .45));
        }};
    }
}
